...
# --------------------------------------------------------------------
def guided_local_search(tsp, work, max_call_cnt):
    obj_call_cnt = 0  # objective function call count
    # update penalty
    ...
    cnt = 0
    while obj_call_cnt < max_call_cnt:
        best_obj = work.obj
        ...
        # update objective function call count
        obj_call_cnt += 1
        # update penalty
        ...
        if work.obj < best_obj:
            print('{}\t{}*\t{}\t{:.2f}'.format(obj_call_cnt,cur_work.obj,work.obj,cur_time-start_time))
...
def two_opt_search(tsp, work, cur_work):
    no_improvement_count = 0  # no improvement count
