...
def main():
    ...
    # generar mejor poblacion
    # poblacion1, _ = generar_poblacion_inicial(tsp, 2, 0)
    # for luciernaga in poblacion1:
    #     print("Luciernaga "  + ": " + str(luciernaga.ruta) + " - " + str(luciernaga.costo_recorrido(tsp)) + " - " + str(luciernaga.intensidad_luz))
    # poblacion = generar_mejores_luciernagas(tsp, 2)
    ...
    indice_actualizacion = 1
    tamano_seccion = 6
    max_call_objetive_function = 25000
